    ...
    public function getConfirmButton($advisors=null, $approving=null, $link='headdepartment/approving')
    {
        ...
        if ($user_status=='confirmed') {
            ...
            if ($enable_approve_button) {
                $html .= "<button class='uk-button uk-button-primary uk-button-large' data-uk-modal=\"{target:'#confirm-form'}\"><i class='uk-icon-save'></i> กดรับรองการส่ง</button>";
            } else {
                $html .= "<a class='uk-button uk-button-primary uk-button-large' href='{$link_to}'><i class='uk-icon-home'></i> กลับหน้าหลัก</a> ";
                $html .= "<button disabled class='uk-button uk-button-large'><i class='uk-icon-hourglass-o'></i> ...รอครูที่ปรึกษายืนยันการส่งข้อมูลก่อน...</button>";
            }
        }
        return $html;
    }
