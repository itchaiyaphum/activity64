<ul class="tm-nav uk-nav" data-uk-nav="">
	...
	<li class="<?php echo $this->helper_lib->getActiveMenu('homeroom');?>">
		<a href="<?php echo base_url('headdepartment/homeroom'); ?>"><span class="uk-icon-pie-chart"></span> บันทึกข้อมูลกิจกรรมโฮมรูม</a>
	</li>
	<li class="<?php echo $this->helper_lib->getActiveMenu('approving');?>">
		<a href="<?php echo base_url('headdepartment/approving'); ?>"><span class="uk-icon-pie-chart"></span> รับรองการบันทึกกิจกรรมโฮมรูม</a>
	</li>
	<br/><br/>
</ul>