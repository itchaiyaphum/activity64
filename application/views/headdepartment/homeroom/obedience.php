		...
		<div class="tm-main uk-width-medium-3-4 uk-margin-top uk-margin-bottom">
			...
			<?php echo form_open_multipart(base_url("headdepartment/homeroom/obedience/?id=".$homeroom->id."&group_id=".$group_id), $attributes); ?>
				<div class="uk-button-group uk-width-1-1">
                    ...
                    <a  class="uk-button uk-width-1-4 uk-button-primary" href="<?php echo base_url("headdepartment/homeroom/obedience/?id=".$homeroom->id."&group_id=".$group_id);?>">STEP 2: การให้โอวาท</a>
