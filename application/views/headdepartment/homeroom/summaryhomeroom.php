            ...
            <?php foreach ($group as $group_row) { ?>
                <div class="uk-panel uk-panel-box uk-panel-box-default uk-margin-top uk-overflow-container">
                    ...
                    <div class="uk-panel-badge">
                        <a href="<?= site_url('headdepartment/summaryhomeroom/report').'?id='.$group_row->id ?>" target="_blank"><button type="button" class="uk-button uk-button-primary uk-button-mini submit"><i class="uk-icon-print"></i> Print</button></a>
                    </div>
                    <hr>
