<div class="uk-container uk-container-center">
	<div class="uk-grid">
		...
		<div class="tm-main uk-width-medium-3-4 uk-margin-top uk-margin-bottom">
			...
			<hr/>
            <form action="<?php echo base_url('headadvisor/approving/confirm_save');?>" method="post" name="adminForm" id="adminForm">
			...
			<?php echo $this->headadvisorapproving_model->getConfirmButton($group->approving, 'headadvisor/approving'); ?>
