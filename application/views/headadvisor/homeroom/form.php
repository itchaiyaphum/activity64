<div class="uk-container uk-container-center">
	<div class="uk-grid">
		...
		<div class="tm-main uk-width-medium-3-4 uk-margin-top uk-margin-bottom">
            <form action="<?php echo base_url('headadvisor/homeroom/edit');?>" method="post" name="adminForm" class="uk-form uk-form-horizontal">
    			...
    			<div class="uk-clearfix">
        			...
        			<div class="uk-float-right">
        				...
        				<a href="<?php echo base_url('headadvisor/homeroom/');?>" class="uk-button uk-button-danger">ยกเลิก</a>
        			</div>
    			</div>
    			<hr/>
